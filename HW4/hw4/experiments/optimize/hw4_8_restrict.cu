...
__global__ void __launch_bounds__(BR, 2) flash_attention_kernel(float * __restrict__  d_Q, float * __restrict__ d_K, float * __restrict__ d_V, float * __restrict__ d_O, const int N, const int d);
