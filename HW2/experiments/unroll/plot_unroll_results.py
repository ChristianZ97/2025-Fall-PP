...
ax1.set_ylabel(
    "Total Execution Time (seconds)", fontsize=13, fontweight="bold", color="black"
)
...
# 設定整個圖表的標題
plt.title(
    "Loop Unrolling: Execution Time vs Speedup", fontsize=15, fontweight="bold", pad=20
)
...
print(
    f"  最佳 (unroll={df_hw2a.loc[df_hw2a['Total_Time'].idxmin(), 'Unroll']:.0f}):     "
...
print(
    f"  最佳 (unroll={df_hw2b.loc[df_hw2b['Total_Time'].idxmin(), 'Unroll']:.0f}):     "
